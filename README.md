...
![Player selection screen](docs/images/player-selection.png)
...
![Image creation](docs/images/image-creation1.png) ![Created image](docs/images/image-created1.png)
...
![Mini games hub](docs/images/minigames-hub.png)
...
![Settings main](docs/images/settings-main.png)
...
![Settings Gemini models](docs/images/settings-gemini.png)

4. Optionally enter a **Pollinations API key**. Leave blank to use the free public tier.

![Settings Pollinations](docs/images/settings-pollinations.png)
